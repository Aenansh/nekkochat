    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          description: "group-[.toast]:text-[#a1887f]",
          actionButton:
          ...
          error:
            "group-[.toaster]:border-red-900/50 group-[.toaster]:bg-[#1a0505]/95",
          success:
            "group-[.toaster]:border-[#d4af37]/50 group-[.toaster]:bg-[#1a110d]/95",
